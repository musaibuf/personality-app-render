...
const styleDescriptions = {
    ...
    'Driver': {
        ...
        behaviors: ['Make direct eye contact', 'Move quickly and briskly with purpose', 'Speak forcefully and fast-paced', 'Uses direct, bottom-line language', 'Have planning calendars and project outlines displayed in their office'],
    ...
    'Amiable': {
        ...
        behaviors: ['Have a friendly facial expression', 'Make frequent eye contact', 'Uses non-aggressive, non-dramatic gestures', 'Speak slowly and in soft tones with moderate inflection', 'Uses language that is supportive and encouraging', 'Display lots of family pictures in their office'],
